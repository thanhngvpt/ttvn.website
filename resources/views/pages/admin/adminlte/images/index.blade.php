            ...
            <table class="table table-bordered">
                ...
                @foreach( $images as $image )
                    <tr>
                        ...
                        <td>
                            <a href="{!! URL::action('Admin\ImageController@show', $image->id) !!}"
                            ...
                            <a href="#" class="btn btn-block btn-danger btn-xs delete-button"
                               data-delete-url="{!! action('Admin\ImageController@destroy', $image->id) !!}">@lang('admin.pages.common.buttons.delete')</a>
                        </td>
                    </tr>
                @endforeach
            </table>
