            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\UserNotificationController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\UserNotificationController@index') !!}">
                                {!! csrf_field() !!}
                    ...
                    <div class="col-sm-12 wrap-index-table">
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="index-table">
                            ...
                            <tr>
                                ...
                                <th>{!! \PaginationHelper::sort('locale', trans('admin.pages.user-notifications.columns.content')) !!}</th>
                            ...
                            @foreach( $notifications as $notification )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{!! action('Admin\UserNotificationController@show', $notification->id) !!}"
                                           class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                            <i class="la la-edit"></i>
                                        </a>
                                        <a href="javascript:;"
                                           data-delete-url="{!! action('Admin\UserNotificationController@destroy', $notification->id) !!}"
