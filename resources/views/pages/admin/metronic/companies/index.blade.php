            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\CompanyController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\CompanyController@index') !!}">
                                {!! csrf_field() !!}
                                ...
                                <tr>
                                    <th style="width: 10px">{!! \PaginationHelper::sort('id', 'ID') !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('name', trans('admin.pages.companies.columns.name')) !!}</th>
                                                                                                                                                                                                        <th>{!! \PaginationHelper::sort('link', trans('admin.pages.companies.columns.link')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('is_enabled', trans('admin.pages.companies.columns.is_enabled')) !!}</th>
                                ...
                                @foreach( $companies as $company )
                                    <tr>
                                        <td>{{ $company->id }}</td>
                                                                                ...
                                                                                <td>
                                            <a href="{!! action('Admin\CompanyController@show', $company->id) !!}" class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\CompanyController@destroy', $company->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
