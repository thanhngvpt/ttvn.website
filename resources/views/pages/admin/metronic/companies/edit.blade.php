...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <form class="m-form m-form--fit" action="@if($isNew){!! action('Admin\CompanyController@store') !!}@else{!! action('Admin\CompanyController@update', [$company->id]) !!}@endif" method="POST">
                ...
                <div class="m-portlet__body" style="padding-top: 0;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group m-form__group row" style="max-width: 500px;">
                                        ...
                                        <p class="help-block" style="font-weight: bolder; display: block; width: 100%; text-align: center;">
                                            @lang('admin.pages.companies.columns.cover_image_id')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group m-form__group row @if ($errors->has('link')) has-danger @endif">
                                        <label for="link">@lang('admin.pages.companies.columns.link')</label>
                                        <input type="text" class="form-control m-input" name="link" id="link" required placeholder="@lang('admin.pages.companies.columns.link')" value="{{ old('link') ? old('link') : $company->link }}">
                                    </div>
                                </div>
                            </div>
                                                                                                <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group m-form__group row @if ($errors->has('is_enabled')) has-danger @endif">
                                        <label for="is_enabled" class="label-switch">@lang('admin.pages.companies.columns.is_enabled')</label>
