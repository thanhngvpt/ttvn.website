                            ...
                            <thead>
                                <tr>
                                    <th style="width: 10px">{!! \PaginationHelper::sort('id', 'ID') !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('name', trans('admin.pages.new-categories.columns.name')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('slug', trans('admin.pages.new-categories.columns.slug')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('meta_title', trans('admin.pages.new-categories.columns.meta_title')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('meta_description', trans('admin.pages.new-categories.columns.meta_description')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('order', trans('admin.pages.new-categories.columns.order')) !!}</th>
