...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        ...
        <div class="m-portlet__body">
            ...
            <form class="m-form m-form--fit" action="@if($isNew){!! action('Admin\LeaderShipController@store') !!}@else{!! action('Admin\LeaderShipController@update', [$leaderShip->id]) !!}@endif" method="POST">
                ...
                <div class="m-portlet__body" style="padding-top: 0;">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group m-form__group row @if ($errors->has('file')) has-danger @endif">
                                        ...
                                        <input type="text" class="form-control m-input" name="file" id="file" required placeholder="@lang('admin.pages.leader-ships.columns.file')" value="{{ old('file') ? old('file') : $leaderShip->file }}">
                                    </div>
                                </div>
                            </div>
                                                                                                <div class="row">
