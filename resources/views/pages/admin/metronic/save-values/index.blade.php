...
@section('title')
     SaveValue | Admin | {{ config('site.name') }}
@stop
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\SaveValueController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\SaveValueController@index') !!}">
                                {!! csrf_field() !!}
                ...
                <div class="row">
                    <div class="col-sm-12 wrap-index-table">
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="index-table">
                            <thead>
                                <tr>
                                    <th style="width: 10px">{!! \PaginationHelper::sort('id', 'ID') !!}</th>
                                                                                                                                                                                                        <th>{!! \PaginationHelper::sort('value', trans('admin.pages.save-values.columns.value')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('content', trans('admin.pages.save-values.columns.content')) !!}</th>
                            ...
                            <tbody>
                                @foreach( $saveValues as $saveValue )
                                    <tr>
                                        <td>{{ $saveValue->id }}</td>
                                                                                                                                                                                                                        <td>{{ $saveValue->value }}</td>
                                                                                                                            <td>{{ $saveValue->content }}</td>
                                                                                <td>
                                            <a href="{!! action('Admin\SaveValueController@show', $saveValue->id) !!}" class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\SaveValueController@destroy', $saveValue->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
