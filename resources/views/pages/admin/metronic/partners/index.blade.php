@extends('pages.admin.metronic.layout.application',['menu' => 'partners'] )
...
@section('title')
     Partner | Admin | {{ config('site.name') }}
@stop
            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\PartnerController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\PartnerController@index') !!}">
                                {!! csrf_field() !!}
                                ...
                                @foreach( $partners as $partner )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\PartnerController@destroy', $partner->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
