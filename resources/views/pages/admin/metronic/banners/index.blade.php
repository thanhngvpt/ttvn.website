            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="{!! action('Admin\BannerController@create') !!}" class="btn m-btn--pill m-btn--air btn-outline-success btn-sm">
                            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div id="m_table_1_filter" class="dataTables_filter">
                            <form method="get" accept-charset="utf-8" action="{!! action('Admin\BannerController@index') !!}">
                                {!! csrf_field() !!}
                            ...
                            <thead>
                                <tr>
                                    <th style="width: 10px">{!! \PaginationHelper::sort('id', 'ID') !!}</th>
                                                                                                                                                                                                        <th>{!! \PaginationHelper::sort('title', trans('admin.pages.banners.columns.title')) !!}</th>
                                                                                                                                                                                                                                                                                            <th>{!! \PaginationHelper::sort('order', trans('admin.pages.banners.columns.order')) !!}</th>
                                                                                                                    <th>{!! \PaginationHelper::sort('is_enabled', trans('admin.pages.banners.columns.is_enabled')) !!}</th>
                                ...
                                @foreach( $banners as $banner )
                                    <tr>
                                        <td>{{ $banner->id }}</td>
                                                                                                                                                                                                                        <td>{{ $banner->title }}</td>
                                                                                                                                                                                                                                                                                                                    <td>{{ $banner->order }}</td>
                                                                                                                            <td>{{ $banner->is_enabled }}</td>
                                                                                <td>
                                            <a href="{!! action('Admin\BannerController@show', $banner->id) !!}" class="btn m--font-primary m-btn--pill m-btn--air no-padding">
                                                <i class="la la-edit"></i>
                                            </a>
                                            <a href="javascript:;" data-delete-url="{!! action('Admin\BannerController@destroy', $banner->id) !!}" class="btn m--font-danger m-btn--pill m-btn--air no-padding delete-button">
