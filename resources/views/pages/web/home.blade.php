        ...
        <div class="list-top-field">
          <div class="row">
            <div class="col-md-4">
              <div class="item-top-field">
                <div class="img-topfield">
                  <img src="{{ asset('images/top-field-1.png') }}" class="img-fluid">
                </div>
                <a class="title-topfield" href="#">
                  Công nghệ cao
                  <img src="{{ asset('images/arrow-right-active.png') }}" class="img-fluid" />
                </a>
            ...
            <div class="col-md-4">
              <div class="item-top-field">
                <div class="img-topfield">
                  <img src="{{ asset('images/top-field-2.png') }}" class="img-fluid">
                </div>
                <a class="title-topfield" href="#">
                  Năng lượng tái tạo
                  <img src="{{ asset('images/arrow-right-active.png') }}" class="img-fluid" />
            ...
            <div class="col-md-4">
              <div class="item-top-field">
                <div class="img-topfield">
                  <img src="{{ asset('images/top-field-3.png') }}" class="img-fluid">
                </div>
                <a class="title-topfield" href="#">
                  Bất động sản
                  <img src="{{ asset('images/arrow-right-active.png') }}" class="img-fluid" />
        ...
        <div class="top-intro">
          <div class="text-top-intro">
            ...
            <a href="#" class="btn btn-outline-success">
              Xem thêm
              <img src="{{ asset('images/arrow-right-active.png') }}" class="img-fluid ml-2" />
            </a>
          </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="col-top-sumary">
                <img src="{{ asset('images/top-sumary-1.png') }}" class="img-fluid" />
                <div class="number">
                  24
                </div>
                <div class="name">
            ...
            <div class="col-md-3">
              <div class="col-top-sumary">
                <img src="{{ asset('images/top-sumary-2.png') }}" class="img-fluid" />
                <div class="number">
                  96
                </div>
                <div class="name">
            ...
            <div class="col-md-3">
              <div class="col-top-sumary">
                <img src="{{ asset('images/top-sumary-3.png') }}" class="img-fluid" />
                  <div class="number">
                  32
                </div>
                <div class="name">
            ...
            <div class="col-md-3">
              <div class="col-top-sumary">
                <img src="{{ asset('images/top-sumary-4.png') }}" class="img-fluid" />
                <div class="number">
                  04
                </div>
                <div class="name">
